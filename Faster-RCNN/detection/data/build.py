...
cityscapes_images_dir = '/data/piaozhengquan/datasets/Cityscapes/leftImg8bit'
foggy_cityscapes_images_dir = '/data/piaozhengquan/datasets/Cityscapes/leftImg8bit_foggy'

DATASETS = {
    'cityscapes_train': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_train_cocostyle.json',
        'root': cityscapes_images_dir+"/train",
    },

    'cityscapes_val': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_coco_val.json',
        'root': cityscapes_images_dir+"/val",
    },

    'cityscapes_test': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_coco_test.json',
        'root': cityscapes_images_dir+"/test",
    },

    'foggy_cityscapes_train': {
        'ann_file': '/data/piaozhengquan/datasets/CityScapes/cocoAnnotations/foggy_cityscapes_coco_train.json',
        'root': foggy_cityscapes_images_dir+"/train",
    },

    'foggy_cityscapes_val': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_foggy_val_cocostyle.json',
        'root': foggy_cityscapes_images_dir+"/val",
    },

    'foggy_cityscapes_train_0.02': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_foggy_train_cocostyle.json',
        'root': foggy_cityscapes_images_dir+"/train",
        'betas': 0.02,
    },
    ...
    'foggy_cityscapes_test': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/foggy_cityscapes_coco_test.json',
    ...
    # -----------sim10k----------
    'sim10k': {
        'root': '/data/piaozhengquan/datasets/Sim10k/VOC/Sim10k',
        'split': 'trainval10k_caronly',
    },
    'cityscapes_car_train': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_train_caronly_cocostyle.json',
        'root': cityscapes_images_dir  + '/train',
    },

    'cityscapes_car_val': {
        'ann_file': '/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_val_caronly_cocostyle.json',
        'root': cityscapes_images_dir  + '/val',
    },
    ...
    "sim10k_trainval_caronly": {
            "data_dir": "/data/piaozhengquan/datasets/Sim10k/VOC/Sim10k",
            "split": "trainval10k_caronly"
        },
    "kitti_train_caronly": {
        "data_dir": "/data/piaozhengquan/datasets/KITTI/VOC",
        "split": "train_caronly"
    },

    "cityscapes_val_caronly_cocostyle": {
            "img_dir": "/data/piaozhengquan/datasets/Cityscapes/leftImg8bit/val",
            "ann_file": "/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_val_caronly_cocostyle.json"
        },
    "cityscapes_train_caronly_cocostyle": {
            "img_dir": "/data/piaozhengquan/datasets/Cityscapes/leftImg8bit/train",
            "ann_file": "/data/piaozhengquan/datasets/Cityscapes/cocoAnnotations/cityscapes_train_caronly_cocostyle.json"
        },

    # -----------kitti----------
    'kitti_train': {
        'root': "/data/piaozhengquan/datasets/KITTI/VOC",
        'split': 'train_caronly',
    },
